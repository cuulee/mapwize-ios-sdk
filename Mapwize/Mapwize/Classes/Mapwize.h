...
//! Project version number for Mapwize.
FOUNDATION_EXPORT double MapwizeVersionNumber;

//! Project version string for Mapwize.
FOUNDATION_EXPORT const unsigned char MapwizeVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <Mapwize/PublicHeader.h>
